...
from agent_state import finalize_agent_run
from app_config import MCP_URL, logger
from chat_helpers import (
    build_tool_debug_from_messages,
    extract_mcp_attachments_from_messages,
    last_assistant_text,
)
from hitl_tools import normalize_interrupts
...
async def stream_agent_hitl_resume(
    ...
    *,
    ...
    from agent_service import hitl_available
